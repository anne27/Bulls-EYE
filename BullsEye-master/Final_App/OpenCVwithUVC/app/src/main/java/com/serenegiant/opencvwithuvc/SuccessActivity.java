...
//				  Toast.makeText(this, "Here"+val3+val3.length(), Toast.LENGTH_SHORT).show();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it=new Intent(SuccessActivity.this,MainnActivity.class);
        ...
        Upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent it=new Intent(SuccessActivity.this,ServerUploadActivity.class);
                it.putExtra("message", e4.getText());
                startActivity(it);
                finish();
