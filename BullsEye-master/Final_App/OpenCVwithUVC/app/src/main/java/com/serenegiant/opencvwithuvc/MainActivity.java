...
public final class MainActivity extends BaseActivity
	 ...
	 * (writing frame data into Surface camera from Medi
	 * aCodec
		...
		runOnUiThread(new Runnable() {
			...
			public void run() {
				try {
					...
					if (st != null) { //This is the code for the screen behind i.e not the OpenCV wala screen so c
										// ommmenting it will only display the inner screen
